...
#)
kml_dir <- "/home/pantro/Descargas/GPS VANCAN 2023 JLByR//"
kml_files <- c(
...
htmlwidgets::saveWidget(
  m,
  #"~/Documentos/GITHUB/R/mapas/KML/2022/ruta_gps_JBYR_cuadras.html",
  "~/Documentos/GITHUB/R/mapas/KML/2023/ruta_gps_JBYR_cuadras.html",
